...
const BodyScanCameraScreen = ({ navigation }) => {
  ...
  const takePicture = async () => {
    if (cameraRef.current && cameraReady) {
      try {
        ...
        navigation.navigate("BodyScanLoading", { photoUri: photo.uri });
      } catch (error) {
      ...
      <Container>
        <View style={tw`flex-1 items-center justify-center p-6`}>
          ...
          <Text style={tw`text-neutral-600 text-center mb-6`}>
            We need camera access to analyze your body composition. Please
      ...
      {Platform.OS === "ios" && Platform.isPad ? (
        ...
        <View style={tw`flex-1 items-center justify-center bg-black`}>
          ...
          <Button
            ...
            onPress={() => {
              ...
              navigation.navigate("BodyScanResultScreen", {
                imageUri:
                  "https://via.placeholder.com/400x800.png?text=Mock+Body+Scan",
              });
            }}
          />
          <TouchableOpacity
        ...
        >
          <View style={tw`flex-1 bg-transparent`}>
            ...
            <View style={tw`flex-1 items-center justify-center`}>
              <View
                style={tw`border-2 border-white border-opacity-70 rounded-lg w-4/5 h-3/4 items-center justify-center`}
              >
